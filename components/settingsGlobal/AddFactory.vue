        ...
        <div class="attention-body">
          ...
          <div class="box select">
            <div class="first-step-object">
              <input v-model.lazy="form.name" placeholder="Название завода" autocomplete="off"
                     type="text"/>
          ...
          <div class="first-step-object">
            <input v-model.lazy="form.map" placeholder="Местоположение" autocomplete="off" id="name"
                   type="text"/>
...
export default {
  ...
  created() {
    if(this.id) {
      ...
      this.form.reserve1 = factories[0].reserv1_id;
      this.form.reserve2 = factories[0].reserv2_id;
      this.form.organisation = factories[0].organisation_id;
      this.form.company = factories[0].company_id;
