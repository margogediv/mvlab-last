<template>
  <div class="section">
    ...
    <div class="sub-panel">
      <div class="subMenu">
        <button href="#" class="subMenu_item btn_icon">Цех ковки тяжелых конструкций и древесины</button>
      </div>

      <div class="subMenu">
        <button href="#" class="subMenu_item btn_icon">Цех отлива тяжелых конструкций и древесины</button>
      </div>
    </div>
    ...
    <div class="charts-items">
      <ul>
        <li v-for="chartOption in chartOptions" :key="chartOption.id" :chart="chartOption">
